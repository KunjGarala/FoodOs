        ...
        <div className="min-h-screen bg-slate-50 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
                <div className="text-center mb-10">
                    <h2 className="text-3xl font-bold text-slate-900">Setup Your Restaurant</h2>
                    <p className="mt-2 text-slate-500">Please provide details about your restaurant to get started.</p>
                </div>
                            ...
                            <div>
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <Input
                                        ...
                                        className="h-10 pt-1.5 file:mr-4 file:py-1 file:px-2 file:rounded-md file:border-0 file:text-xs file:font-medium file:bg-slate-100 file:text-slate-700 hover:file:bg-slate-200"
                                    />
                                </div>
                            </div>
